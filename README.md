...
| 64 | Create new user, delete it and verify by getting data by email            | Status Code 404, message: 'Account not found with this email, try another email!'                | Status Code 404, correct message          | Passed |
